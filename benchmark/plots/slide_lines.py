...
CONC_DATA = {
    "dflash-official": {
        1: dict(
            accept_pr=6.436, accept_pr_sem=0.1382,
    ...
    "dflash2": {
        1: dict(
            ...
            vs_dflash_pr=0.9912, vs_dflash_pr_sem=0.0093,
            vs_dflash=0.9912, vs_dflash_ci=(0.9533, 1.029),
        ...
        2: dict(
            ...
            vs_dflash_pr=1.0529, vs_dflash_pr_sem=0.0097,
            vs_dflash=1.0663, vs_dflash_ci=(1.0337, 1.0991),
        ...
        8: dict(
            ...
            vs_dflash_pr=1.0034, vs_dflash_pr_sem=0.0088,
            vs_dflash=1.0145, vs_dflash_ci=(0.9884, 1.0379),
        ...
        32: dict(
            ...
            vs_dflash_pr=1.0012, vs_dflash_pr_sem=0.0099,
            vs_dflash=1.0097, vs_dflash_ci=(0.9795, 1.0367),
    ...
    "dflash2-run-d-mid": {
        1: dict(
            ...
            vs_dflash_pr=1.1053, vs_dflash_pr_sem=0.0112,
            vs_dflash=1.0311, vs_dflash_ci=(0.9996, 1.0668),
        ...
        2: dict(
            ...
            vs_dflash_pr=1.1737, vs_dflash_pr_sem=0.0128,
            vs_dflash=1.0943, vs_dflash_ci=(1.0554, 1.1382),
        ...
        8: dict(
            ...
            vs_dflash_pr=1.1013, vs_dflash_pr_sem=0.011,
            vs_dflash=1.0267, vs_dflash_ci=(0.9917, 1.0619),
        ...
        32: dict(
            ...
            vs_dflash_pr=1.1156, vs_dflash_pr_sem=0.0128,
            vs_dflash=1.044, vs_dflash_ci=(1.0146, 1.0718),
    ...
    "dflash2-run-d-final": {
        1: dict(
            ...
            vs_dflash_pr=1.1191, vs_dflash_pr_sem=0.0115,
            vs_dflash=1.0555, vs_dflash_ci=(1.0106, 1.101),
        ...
        2: dict(
            ...
            vs_dflash_pr=1.1834, vs_dflash_pr_sem=0.0129,
            vs_dflash=1.0901, vs_dflash_ci=(1.0535, 1.1326),
        ...
        8: dict(
            ...
            vs_dflash_pr=1.1099, vs_dflash_pr_sem=0.0109,
            vs_dflash=1.0709, vs_dflash_ci=(1.0396, 1.1048),
        ...
        32: dict(
            ...
            vs_dflash_pr=1.1635, vs_dflash_pr_sem=0.0134,
            vs_dflash=1.0646, vs_dflash_ci=(1.0256, 1.1016),
    ...
    "dspark-community": {
        1: dict(
            ...
            vs_dflash_pr=0.6463, vs_dflash_pr_sem=0.0093,
            vs_dflash=0.7303, vs_dflash_ci=(0.701, 0.7562),
        ...
        2: dict(
            ...
            vs_dflash_pr=0.6666, vs_dflash_pr_sem=0.0097,
            vs_dflash=0.7656, vs_dflash_ci=(0.7328, 0.7946),
        ...
        8: dict(
            ...
            vs_dflash_pr=0.6623, vs_dflash_pr_sem=0.0099,
            vs_dflash=0.7415, vs_dflash_ci=(0.713, 0.7689),
        ...
        32: dict(
            ...
            vs_dflash_pr=0.66, vs_dflash_pr_sem=0.0096,
            vs_dflash=0.7401, vs_dflash_ci=(0.7111, 0.7673),
    ...
    "dspark-run-a-32k": {
        1: dict(
            ...
            vs_dflash_pr=1.0178, vs_dflash_pr_sem=0.01,
            vs_dflash=0.9518, vs_dflash_ci=(0.9254, 0.9817),
        ...
        2: dict(
            ...
            vs_dflash_pr=1.0338, vs_dflash_pr_sem=0.0117,
            vs_dflash=0.9815, vs_dflash_ci=(0.9488, 1.0142),
        ...
        8: dict(
            ...
            vs_dflash_pr=1.0304, vs_dflash_pr_sem=0.01,
            vs_dflash=0.962, vs_dflash_ci=(0.9351, 0.9918),
        ...
        32: dict(
            ...
            vs_dflash_pr=1.0651, vs_dflash_pr_sem=0.0114,
            vs_dflash=0.9973, vs_dflash_ci=(0.9716, 1.0246),
    ...
    "dspark-run-b-49k": {
        1: dict(
            ...
            vs_dflash_pr=1.0162, vs_dflash_pr_sem=0.0099,
            vs_dflash=0.9473, vs_dflash_ci=(0.9201, 0.9772),
        ...
        2: dict(
            ...
            vs_dflash_pr=1.0202, vs_dflash_pr_sem=0.0098,
            vs_dflash=0.9616, vs_dflash_ci=(0.9324, 0.9968),
        ...
        8: dict(
            ...
            vs_dflash_pr=1.0382, vs_dflash_pr_sem=0.0106,
            vs_dflash=0.9623, vs_dflash_ci=(0.9265, 0.9991),
        ...
        32: dict(
            ...
            vs_dflash_pr=1.0927, vs_dflash_pr_sem=0.0102,
            vs_dflash=1.0078, vs_dflash_ci=(0.9696, 1.0476),
...
METRICS = {
    ...
    "vs_dflash": dict(
        ...
        per_turn=dict(field="vs_dflash_pr", sem="vs_dflash_pr_sem", ci=None,
                      note="mean over turns of that turn's rate \u00f7 DFlash "
                           "official's rate on the SAME call, error bars = SEM (n={n})"),
        pooled=dict(field="vs_dflash", sem=None, ci="vs_dflash_ci",
                    note="pooled tok/s \u00f7 DFlash official's at the same "
                         "concurrency; error bars = 95% paired bootstrap CI"),
